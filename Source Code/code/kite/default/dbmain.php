			...
			<div class="pattern height-resize">
				<div class="container">
					...
					<?php
						...
						$quer1=mysql_query("SELECT name,address,status,price FROM node;");
						
						if(!$quer1)
							die("Data could not insert:".mysql_error());
						else{
							echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
							echo "<table><style>table, th, td {align: right; padding: 30px;border: 1px solid white;</style><tr><th>Name</th>&nbsp;&nbsp;<th>Status</th>&nbsp;&nbsp;<th>Price</th><th>Navigation View</th></tr>";
