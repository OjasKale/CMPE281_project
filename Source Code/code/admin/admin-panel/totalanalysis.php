...
<form>
  ...
  <div class="container body-content">
    ...
    <div id="visualization" style="width: 600px; height: 400px;"></div>
        ...
        $quer1=mysql_query("select SUM(total_slots) as Total,SUM(available_slots) as Available from node;");
     ...
     <!-- load api -->
        ...
        <script type="text/javascript">
           ...
           ['Unavailable',<?php echo ($row['Total']-$row['Available']); ?>]
        ]);
           
 
                // Create and draw the visualization.
                new google.visualization.PieChart(document.getElementById('visualization')).
                draw(data, {title:"Total Parking available"});
            }
 ...
 <script type="text/javascript">
	...
	function drawMaterial() {
      var data = google.visualization.arrayToDataTable([
        ['Name of Garage', 'Total Slots', 'Available Slots'],
      ...
      var options = {
        chart: {
          title: 'Garage wise Parking Slot allotment'
        },
        hAxis: {
          title: '',
          minValue: 0,
