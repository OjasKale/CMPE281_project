      ...
      <div class="col-xs-12 col-sm-8">
        <div class="panel-group"
             ...
             data-pdsa-collapser-close="glyphicon glyphicon-minus">
				...
				<form method="post" action="successg.php">
				 <input type="text" placeholder="Garage Name:" name="garagename"/></br></br>
				<input type="text" placeholder="Address:" name="address"/></br></br>
				<input type="text" placeholder="Price:" name="price"/> </br></br>
				<input type="text" placeholder="Parking Slots:" name="slots"/></br></br>
				<input type="submit" value="AddGarage"/>
				</form>
