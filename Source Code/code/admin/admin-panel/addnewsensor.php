        ...
        <div class="panel-group"
             ...
             data-pdsa-collapser-close="glyphicon glyphicon-minus">
				 ...
				 <?php
						...
						$query=mysql_query("UPDATE node SET total_slots=(total_slots+1) WHERE id=$id ");
						
						$query=mysql_query("INSERT INTO node_log (node_id,status) VALUES('$id','0');");
						echo "Sucessfully Added New Sensor";
						?>
